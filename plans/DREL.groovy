plan(key:'DREL',name:'Release Accessibility Dashboard to Micros (Docker)',
   description:'Create new a11y-dashboard docker image to deploy to Micros.') {
   ...
   stage(name:'Build Docker Image',description:'Create a docker image for release to Micros.') {
      job(key:'BUILD',name:'Build a Docker Image',description:'Run docker commands to create a new a11y-dashboard image.') {
         ...
         task(type:'checkout',description:'Checkout Accessibility Dashboard repository') {
            repository(name:'Accessibility Dashboard')
...
''',
         ...
         task(type:'custom',createTaskKey:'com.atlassian.bamboo.plugins.bamboo-docker-plugin:task.docker.cli',
            ...
            repository:'docker.atlassian.io/atlassian/a11y-dashboard',
         ...
         task(type:'custom',createTaskKey:'com.atlassian.bamboo.plugins.bamboo-docker-plugin:task.docker.cli',
            ...
            pushRepository:'docker.atlassian.io/atlassian/a11y-dashboard',
...
deployment(name:'Deploy Accessibility Dashboard to Micros (Docker)',
   planKey:'A11Y-DREL',description:'Deploy a11y-dashboard package to Micros environments.') {
   versioning(version:'release-1',autoIncrementNumber:'true')

   environment(name:'Domain Development (a11y-dashboard)',
      description:'Domain Development (a11y-dashboard) domain service environment') {
      ...
      task(type:'script',description:'Deploy to Micros environment.',
         scriptBody:'MICROS_TOKEN="$bamboo_micros_token_password" "$(npm bin)/micros" service:deploy "a11y-dashboard" -u cfn-base -f service/service-descriptor.* -e "ddev" -v')
   ...
   environment(name:'Application Development (a11y-dashboard)',
      description:'Application Development (a11y-dashboard) domain service environment') {
      //For security reasons please consider moving the password variable to global variables.
      ...
      task(type:'script',description:'Deploy to Micros environment.',
         scriptBody:'MICROS_TOKEN="$bamboo_micros_token_password" "$(npm bin)/micros" service:deploy "a11y-dashboard" -f service/service-descriptor.* -e "adev" -v')
   ...
   environment(name:'Staging East (a11y-dashboard)',
      description:'Staging East (a11y-dashboard) domain service environment') {
      //For security reasons please consider moving the password variable to global variables.
      ...
      task(type:'script',description:'Deploy to Micros environment.',
         scriptBody:'MICROS_TOKEN="$bamboo_micros_token_password" "$(npm bin)/micros" service:deploy "a11y-dashboard" -f service/service-descriptor.* -e "stg-east" -v')
   ...
   environment(name:'Staging West (a11y-dashboard)',
      description:'Staging West (a11y-dashboard) domain service environment') {
      //For security reasons please consider moving the password variable to global variables.
      ...
      task(type:'script',description:'Deploy to Micros environment.',
         scriptBody:'MICROS_TOKEN="$bamboo_micros_token_password" "$(npm bin)/micros" service:deploy "a11y-dashboard" -f service/service-descriptor.* -e "stg-west" -v')
   ...
   environment(name:'Production East (a11y-dashboard)',
      description:'Production East (a11y-dashboard) domain service environment') {
      //For security reasons please consider moving the password variable to global variables.
      ...
      task(type:'script',description:'Deploy to Micros environment.',
         scriptBody:'MICROS_TOKEN="$bamboo_micros_token_password" "$(npm bin)/micros" service:deploy "a11y-dashboard" -f service/service-descriptor.* -e "prod-east" -v')
   ...
   environment(name:'Production West (a11y-dashboard)',
      description:'Production West (a11y-dashboard) domain service environment') {
      //For security reasons please consider moving the password variable to global variables.
      ...
      task(type:'script',description:'Deploy to Micros environment.',
         scriptBody:'MICROS_TOKEN="$bamboo_micros_token_password" "$(npm bin)/micros" service:deploy "a11y-dashboard" -f service/service-descriptor.* -e "prod-west" -v')
